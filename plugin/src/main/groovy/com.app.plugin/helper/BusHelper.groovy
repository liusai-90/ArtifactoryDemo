...
public class BusHelper {
    final static String OkBusAnnotation = "com.adinnet.annotation.javassist.Bus"
    final static String OkBusRegisterAnnotation = "com.adinnet.annotation.javassist.BusRegister"
    final static String OkBusUnRegisterAnnotation = "com.adinnet.annotation.javassist.BusUnRegister"
    ...
    static String getRegisterEventMethodStr(BusInfo mBusInfo) {
        String CreateStr = "";
        mBusInfo.clazz.addInterface(mBusInfo.clazz.classPool.get("com.adinnet.annotation.event.Event"));//为当前的类添加时间处理的接口
        for (int i = 0; i < mBusInfo.getMethods().size(); i++) {
            ...
            CreateStr += "com.adinnet.annotation.event.OkBus.getInstance().register(" + id + ",(com.adinnet.annotation.event.Event)this," + thread + ");\n"
        }
    ...
    static String getUnRegisterEventMethodStr(mBusInfo) {
        String dis_Str = "";
        mBusInfo.eventIds.each { id -> dis_Str += "com.adinnet.annotation.event.OkBus.getInstance().unRegister(" + id + ",(com.adinnet.annotation.event.Event)this);\n" }
        return dis_Str;
    }
}
